#!/usr/bin/env python3
"""
POC05_V02 All Formats - Create Vector Index for 28,823 chunks
Index: poc05_v02_all_formats_hybrid_rag_index
Source: poc05_v02_all_formats_with_metadata (docx + pdf + xlsx)
Features: Hybrid search + metadata filtering + 25,453 table definitions
"""
...
def main():
    print("=" * 80)
    print("POC05_V02 ALL FORMATS - CREATE VECTOR INDEX")
    print("=" * 80)
    ...
    source_table = config['rag_config']['poc05_v02_all_formats_metadata_table']
    index_name = f"{namespace}.poc05_v02_all_formats_hybrid_rag_index"
    ...
    # Create vector index
    print(f"\n[7] Creating POC05_V02 All Formats vector index...")
    ...
    print(f"      - Multi-format support (docx + pdf + xlsx)")
    ...
    try:
        ...
        config['rag_config']['poc05_v02_all_formats_index'] = index_name
        config['rag_config']['poc05_v02_all_formats_index_created_at'] = time.strftime("%Y-%m-%dT%H:%M:%S")
        ...
        # Summary
        print("\n" + "=" * 80)
        print("POC05_V02 ALL FORMATS INDEX CREATION COMPLETE")
        print("=" * 80)
        print(f"\nIndex: {index_name}")
        print(f"Source: {source_table}")
