#!/usr/bin/env python3
"""
POC06_v02 - Create Vector Index with Improved Chunks
Index: poc06_v02_hybrid_rag_index
Source: poc06_v02_with_metadata (docx + pdf + xlsx + pptx)
...
def main():
    print("=" * 80)
    print("POC06_v02 - CREATE VECTOR INDEX (IMPROVED CHUNKING)")
    print("=" * 80)
    ...
    source_table = config['rag_config']['poc06_v02_metadata_table']
    index_name = f"{namespace}.poc06_v02_hybrid_rag_index"
    ...
    # Create vector index
    print(f"\n[7] Creating POC06_v02 vector index...")
    ...
    try:
        ...
        config['rag_config']['poc06_v02_index'] = index_name
        config['rag_config']['poc06_v02_index_created_at'] = time.strftime("%Y-%m-%dT%H:%M:%S")
        ...
        # Summary
        print("\n" + "=" * 80)
        print("POC06_v02 INDEX CREATION COMPLETE")
        print("=" * 80)
        print(f"\nIndex: {index_name}")
        print(f"Source: {source_table}")
