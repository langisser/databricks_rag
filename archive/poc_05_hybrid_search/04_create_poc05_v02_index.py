#!/usr/bin/env python3
"""
POC05_V02 - Create Vector Index with Hybrid Search Support and Metadata
Index: poc05_v02_hybrid_rag_index
Source: poc05_v02_chunks_with_metadata (with content_category, document_type, etc.)
"""
...
def main():
    print("=" * 80)
    print("POC05_V02 - CREATE VECTOR INDEX WITH HYBRID SEARCH")
    print("=" * 80)
    ...
    source_table = config['rag_config']['poc05_v02_metadata_table']
    index_name = f"{namespace}.poc05_v02_hybrid_rag_index"
    ...
    # Create vector index
    print(f"\n[7] Creating POC05_V02 vector index...")
    ...
    try:
        ...
        config['rag_config']['poc05_v02_index'] = index_name
        config['rag_config']['poc05_v02_index_created_at'] = time.strftime("%Y-%m-%dT%H:%M:%S")
        ...
        # Summary
        print("\n" + "=" * 80)
        print("POC05_V02 INDEX CREATION COMPLETE")
        print("=" * 80)
        print(f"\nIndex: {index_name}")
        print(f"Source: {source_table}")
